# Новостное приложение NewsToDay 
...
В этом репозитории хранится приложение, которое позволяет первым узнавать новости из 150 000 источников по всему миру. / This repository contains an application that allows you to be the first to learn news from 150,000 sources around the world.
